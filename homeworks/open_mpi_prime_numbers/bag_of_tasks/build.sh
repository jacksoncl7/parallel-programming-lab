...
mpicc bag_of_tasks_rsend_irecv.c -o3 -lm -o build/rsend_irecv
mpicc bag_of_tasks_ssend_recv.c -o3 -lm -o build/ssend_recv
mpicc bag_of_tasks_ssend_irecv.c -o3 -lm -o build/ssend_irecv